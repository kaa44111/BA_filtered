...
# Initialize W&B at the start of your script
wandb.init(project="test_dataset")

# Optional: You can log configuration details (like hyperparameters)
wandb.config = {
  "learning_rate": 1e-4,
  "epochs": 30,
  "batch_size": 25
...
def run(UNet,dataloader,dataset_name,save_name=None):
    ...
    wandb.save(save_dir, symlink = False)
